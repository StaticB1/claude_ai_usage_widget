...
from .config import (API_REFRESH_INTERVAL, API_REFRESH_INTERVAL_HIDDEN,
                     APP_ID, APP_NAME, APP_VERSION, LOCAL_SCAN_INTERVAL,
    ...
    def _local_loop(self):
        ...
        while self._running:
            try:
                ...
                if imported and self.window:
                    GLib.idle_add(self.window.refresh_data)
    ...
    def _api_loop(self):
        while self._running:
            ...
            interval = (self._settings.poll_interval_seconds
                        ...
                        else max(self._settings.poll_interval_seconds * 2,
                                 API_REFRESH_INTERVAL_HIDDEN))
            sleep_for = interval
